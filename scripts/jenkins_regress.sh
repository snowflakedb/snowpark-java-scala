...
exit_code_decorator "sbt UDFTests:testOnly * -- -l com.snowflake.snowpark.SampleDataTest"
exit_code_decorator "sbt \"++ 2.13.16 UDFTests:testOnly * -- -l com.snowflake.snowpark.UDFPackageTest -l com.snowflake.snowpark.SampleDataTest\""
