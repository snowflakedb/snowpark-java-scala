...
private[snowpark] object Variant {
  ...
  object VariantTypes {
    ...
    object Boolean extends VariantT

    object String extends VariantT

    object Binary extends VariantT

    object Time extends VariantT

    object Date extends VariantT

    object Timestamp extends VariantT

    object Array extends VariantT

    object Object extends VariantT

    // internal used when converting from Java
    def getType(name: String): VariantT = name match {
...
class Variant private[snowpark] (
  ...
  private def convert[T](target: VariantT)(thunk: => T): T =
