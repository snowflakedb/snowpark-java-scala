...
class ErrorMessageSuite extends FunSuite {
  ...
  test("MISC_INVALID_RSA_PRIVATE_KEY") {
    ...
    assert(
      ex.message.startsWith(
        "Error Code: 0420, Error message: Invalid RSA private key." +
