...
object ColumnIdentifier {
  ...
  /** Creates a [[ColumnIdentifier]] object for the giving column name. Identifier Requirement can
    * be found from https://docs.snowflake.com/en/sql-reference/identifiers-syntax.html
    * @since 0.1.0
    */
