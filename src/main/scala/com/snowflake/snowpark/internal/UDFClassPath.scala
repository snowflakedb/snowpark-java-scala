...
object UDFClassPath extends Logging {
  ...
  val scalaLibraryClass: Class[Product] = classOf[scala.Product]
  val scalaReflectClass: Class[Universe] = classOf[scala.reflect.api.Universe]
  val scalaCompilerClass: Class[Global] = classOf[scala.tools.nsc.Global]
  val scalaJarSeq = Seq(
    RequiredLibrary(getPathForClass(scalaLibraryClass), "scala-library", scalaLibraryClass),
    RequiredLibrary(getPathForClass(scalaReflectClass), "scala-reflect", scalaReflectClass),
    RequiredLibrary(getPathForClass(scalaCompilerClass), "scala-compiler", scalaCompilerClass))
