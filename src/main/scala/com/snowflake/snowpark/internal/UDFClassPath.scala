...
object UDFClassPath extends Logging {
  ...
  val openTelemetryJarSeq = Seq(
    RequiredLibrary(
      getPathForClass(openTelemetryApiClass),
      "opentelemetry-api",
      openTelemetryApiClass),
    RequiredLibrary(
      getPathForClass(openTelemetryContextClass),
      "opentelemetry-context",
      openTelemetryContextClass))
