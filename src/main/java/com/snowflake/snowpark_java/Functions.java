...
public final class Functions {
   ...
   *
   * @since 1.16.0
   * @param udafName The name of UDAF
   * @param cols The list of arguments to pass to the UDAF
   * @return The result column
   */
  public static Column callUDAF(String udafName, Column... cols) {
    return new Column(
        com.snowflake.snowpark.functions.callUDAF(
            udafName, JavaUtils.columnArrayToSeq(Column.toScalaColumnArray(cols))));
  }
